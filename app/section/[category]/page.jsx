    ...
    <>
      <div className="max-w-7xl mx-auto flex-1 min-h-screen flex flex-col">
        ...
        <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 w-full">
            ...
            <article className="mb-10 relative">
                <Link href="/news-details/slug-1" className="group block">
                    <div className="relative">
                        ...
                        <img className="w-full h-48 object-cover rounded" src="https://images.unsplash.com/photo-1635070041078-e363dbe005cb?auto=format&fit=crop&q=80&w=400" alt="Noticia 1"/>
                    </div>

                    <h2 className="w-full text-base mt-2 text-gray-800 group-hover:underline line-clamp-2 font-medium">
                        Los avances en computación cuántica que cambiarán el 2024
                    </h2>
                    ...
                    <div className="flex items-center justify-between mt-2">
                        <div className="flex items-center gap-1 text-gray-500">
                            ...
                            <span className="text-xs font-bold">1,540</span>
                        </div>
                        <time className="text-gray-400 text-sm font-bold">15/02/2024</time>
                    </div>
                </Link>
            </article>

            <article className="mb-10 relative">
                <Link href="/news-details/slug-2" className="group block">
                    <div className="relative">
                        <div className="absolute top-2 left-2 flex items-center gap-1 bg-black/60 text-white px-2 py-1 rounded backdrop-blur-sm z-10">
                            
                            <span className="text-xs font-bold">2</span>
                        </div>
                        <img className="w-full h-48 object-cover rounded" src="https://images.unsplash.com/photo-1506744038136-46273834b3fb?auto=format&fit=crop&q=80&w=400" alt="Noticia 2"/>
                    </div>
                    <h2 className="w-full text-base mt-2 text-gray-800 group-hover:underline line-clamp-2 font-medium">
                        Nuevas rutas de senderismo descubiertas en la Patagonia
                    </h2>
                    <div className="flex items-center justify-between mt-2">
                        <div className="flex items-center gap-1 text-gray-500">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" className="w-4 h-4">
                        ...
                        <time className="text-gray-400 text-sm font-bold">14/02/2024</time>
                    </div>
                </Link>
            </article>

            <article className="mb-10 relative">
                <Link href="/news-details/slug-3" className="group block">
                    <div className="relative">
                        <div className="absolute top-2 left-2 flex items-center gap-1 bg-black/60 text-white px-2 py-1 rounded backdrop-blur-sm z-10">
                            
                            <span className="text-xs font-bold">3</span>
                        </div>
                        <img className="w-full h-48 object-cover rounded" src="https://images.unsplash.com/photo-1490645935967-10de6ba17061?auto=format&fit=crop&q=80&w=400" alt="Noticia 3"/>
                    </div>
                    <h2 className="w-full text-base mt-2 text-gray-800 group-hover:underline line-clamp-2 font-medium">
                        La dieta mediterránea: por qué sigue siendo la mejor opción
                    </h2>
                    <div className="flex items-center justify-between mt-2">
                        <div className="flex items-center gap-1 text-gray-500">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" className="w-4 h-4">
                            ...
                            <span className="text-xs font-bold">2,300</span>
                        </div>
                        <time className="text-gray-400 text-sm font-bold">13/02/2024</time>
                    </div>
                </Link>
            </article>

            <article className="mb-10 relative">
                <Link href="/news-details/slug-4" className="group block">
                    <div className="relative">
                        <div className="absolute top-2 left-2 flex items-center gap-1 bg-black/60 text-white px-2 py-1 rounded backdrop-blur-sm z-10">
                            
                            <span className="text-xs font-bold">4</span>
                        </div>
                        <img className="w-full h-48 object-cover rounded" src="https://images.unsplash.com/photo-1614728894747-a83421e2b9c9?auto=format&fit=crop&q=80&w=400" alt="Noticia 4"/>
                    </div>
                    <h2 className="w-full text-base mt-2 text-gray-800 group-hover:underline line-clamp-2 font-medium">
                        Exploración espacial: La próxima misión a Marte ya tiene fecha
                    </h2>
                    <div className="flex items-center justify-between mt-2">
                        <div className="flex items-center gap-1 text-gray-500">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" className="w-4 h-4">
                            ...
                            <span className="text-xs font-bold">3,100</span>
                        </div>
                        <time className="text-gray-400 text-sm font-bold">12/02/2024</time>
                    </div>
                </Link>
            </article>
