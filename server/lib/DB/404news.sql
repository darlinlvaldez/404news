...
CREATE TABLE `news` (
  ...
  CONSTRAINT `news_chk_1` CHECK ((`status` in (_utf8mb3'draft',_utf8mb3'review',_utf8mb3'published',_utf8mb3'archived',_utf8mb3'rejected')))
...
(4,'Apple iPhone 16: Cámara cuántica y carga inalámbrica a distancia','iphone-16-camara-cuantica','Apple anuncia su nuevo smartphone con tecnología de cámara revolucionaria','https://cdsassets.apple.com/live/7WUAS350/images/tech-specs/121031-iphone-16-pro.png',2,2,'published','2026-01-31 16:20:00','2026-07-01 08:33:36',2),
(5,'Windows 13 incluye asistente de IA nativo','windows-13-asistente-ia-nativo','Microsoft integra Copilot directamente en el sistema operativo','https://i.blogs.es/876678/copilot-novedades/500_333.jpeg',3,3,'published','2026-01-30 10:10:00','2026-07-06 22:52:22',4),
(6,'Nueva versión de Python acelera ejecución en un 40%','python-nueva-version-acelera-ejecucion','Python 3.13 mejora significativamente el rendimiento de aplicaciones','https://pandorafms.com/blog/wp-content/uploads/2018/10/lenguaje-python-featured.png',3,3,'published','2026-01-29 13:55:00','2026-07-06 20:52:22',4),
...
(23,'Starlink alcanza 5 millones de usuarios activos globalmente','starlink-5-millones-usuarios','Servicio de internet satelital expande cobertura a 75 países con velocidades mejoradas','https://cloudfront-us-east-1.images.arcpublishing.com/infobae/BD3QN4RGEVAXDGGAAICM3KXQVQ.png',1,5,'published','2026-01-12 11:15:00','2026-07-07 03:35:09',5),
(24,'Tesla Optimus realiza tareas de fábrica en línea de producción real','tesla-optimus-produccion-real','Robot humanoide de Tesla trabaja junto a humanos ensamblando componentes de vehículos','https://clickpetroleoegas.com.br/wp-content/uploads/2026/01/Design-sem-nome-2026-01-29T190106.112.jpg',3,5,'published','2026-01-11 16:50:00','2026-07-07 22:26:30',3),
(25,'Quantum computer de IBM supera los 1000 qubits útiles','ibm-quantum-1000-qubits','Procesador \"Condor\" marca hito en computación cuántica con corrección de errores integrada','https://i.blogs.es/1df1e8/qubit1/450_1000.jpg',4,5,'published','2026-01-10 09:35:00','2026-07-07 03:35:09',15),
...
(38,'Linux anuncia kernel 100% escrito por IA con supervisión humana','linux-kernel-ia-escrito','Torvalds revela que 85% del código de Linux 7.0 fue generado y verificado por sistemas de IA','https://www.somoslibres.org/images/2022/03/03/ialinux.jpg',3,3,'published','2026-02-15 14:50:00','2026-07-11 03:27:36',3),
...
(42,'AMD APU con 256GB de memoria HBM4 integrada','amd-apu-256gb-hbm4','Chip \"Strix Halo\" elimina necesidad de RAM separada, revolucionando laptops gaming','https://acf.geeknetic.es/imgri/imagenes/auto/2025/11/21/rqe-amd-instinct-mi403x.png?f=webp',4,4,'published','2026-02-05 13:15:00','2026-07-11 18:27:17',4),
...
(44,'Hyperloop comercial conecta NYC-Washington en 25 minutos','hyperloop-nyc-washington-25min','Primera ruta de transporte supersónico subterráneo inaugurada en Estados Unidos','https://i.blogs.es/fc9c44/hyperloop/840_560.png',3,5,'published','2026-02-01 09:40:00','2026-07-01 08:33:35',1),
(45,'Fusión nuclear controlada produce energía neta positiva continua','fusion-nuclear-energia-positiva-continua','Reactor SPARC de MIT logra 24 horas de fusión sostenida, hito histórico energético','https://www.gaceta.unam.mx/wp-content/uploads/2023/01/230109-Aca1-des-f1-fusion-nuclear.jpg',4,5,'published','2026-01-30 14:25:00','2026-07-06 15:52:08',3),
...
(73,'Interpretabilidad mecanicista: nuevas técnicas para entender el funcionamiento interno de los LLMs','interpretabilidad-mecanicista-llms-funcionamiento','Grandes tecnológicas desarrollan métodos para comprender por qué los modelos de IA generan respuestas específicas','https://iaticias.com/wp-content/uploads/2025/04/image-1.png',3,1,'published','2026-01-20 11:10:00','2026-07-06 23:52:22',3),
...
(121,'tu te imaginas chica tu y yo','tu-te-imaginas-chica-tu-y-yo','en un deportivo con los aros veridow','https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQdk-Nr1aBZ9U_mEzMUsf1ORdrLejkreRgOLA&s',1,1,'archived','2026-08-11 21:27:06','2026-08-11 21:41:07',0);
