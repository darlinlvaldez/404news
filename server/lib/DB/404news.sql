...
(9,'Internet satelital alcanza velocidades de 1 Gbps globalmente','internet-satelital-1gbps-global','Proyectos de constelación satelital democratizan el acceso a internet de alta velocidad','https://www.adslzone.net/app/uploads-adslzone.net/2024/01/nave-espacial-que-orbita-planeta-tierra-comunicaciones-globales-generadas-ia.jpg',3,5,'published','2026-01-26 12:15:00','2026-06-23 08:30:02',2),
(10,'Robots humanoides realizan tareas domésticas complejas','robots-humanoides-tareas-domesticas','Nueva generación de robots asistentes aprenden y se adaptan a entornos domésticos','https://www.infobae.com/new-resizer/tIpR57VRa38zapjgpaE9nl0rObM=/arc-anglerfish-arc2-prod-infobae/public/WPTXEEPKV5CYBHADF3XIWNT3P4.png',1,5,'published','2026-01-25 17:30:00','2026-06-21 03:01:43',2),
...
(13,'ChatGPT obtiene capacidad de memoria a largo plazo','chatgpt-memoria-largo-plazo','OpenAI actualiza su modelo para recordar conversaciones anteriores y preferencias del usuario','https://cloudfront-us-east-1.images.arcpublishing.com/infobae/C2RUS3WYTJBVLEWKMLRNPB2DYQ.png',1,1,'published','2026-01-22 11:30:00','2026-06-20 13:50:34',2),
...
(15,'Xiaomi presenta smartphone con batería de estado sólido de 6000mAh','xiaomi-bateria-estado-solido','Nueva tecnología de batería ofrece carga completa en 8 minutos y mayor seguridad','https://blob.tusbuenasnoticias.com/images/2025/12/30/vale-la-pena-el-poco-c85-con-bateria-de-6000-mah-y-doble-camara-en-remate-706e2adf-focus-0-0-1200-600.webp',2,2,'published','2026-01-20 09:50:00','2026-06-21 02:31:45',2),
(16,'Nothing Phone (3) con pantalla holográfica retroiluminada','nothing-phone-3-pantalla-holografica','Interfaz Glyph Interface evoluciona con efectos de luz 3D y notificaciones contextuales','https://i.blogs.es/2a45d5/nothing3/450_1000.jpeg',2,2,'published','2026-01-19 13:40:00','2026-06-20 13:53:44',2),
...
(18,'Kubernetes 1.30 simplifica la gestión de clusters con IA','kubernetes-1-30-gestion-ia','Nueva versión incluye operadores auto-curativos y optimización automática de recursos','https://www.muylinux.com/wp-content/uploads/2023/10/Kubernetes.png',3,3,'published','2026-01-17 15:10:00','2026-06-21 02:31:44',2),
(19,'Linux 6.10 mejora soporte para hardware ARM y RISC-V','linux-6-10-soporte-arm-riscv','Kernel actualizado optimiza rendimiento en procesadores de arquitectura alternativa','https://blog.underc0de.org/wp-content/uploads/2024/07/R.jpg',3,3,'published','2026-01-16 12:05:00','2026-06-20 14:17:10',2),
(20,'AMD Ryzen 9000: hasta 24 núcleos y frecuencia de 6GHz','amd-ryzen-9000-24-nucleos','Nueva arquitectura Zen 5 ofrece mejora del 35% en rendimiento single-thread','https://www.amd.com/content/dam/amd/en/images/products/processors/ryzen/2613900-ryzen-9-9950x.jpg',4,4,'published','2026-02-14 12:20:49','2026-07-01 00:12:05',9),
(21,'Apple MacBook Pro M4 con Neural Engine de 50 TOPS','macbook-pro-m4-neural-engine','Chip M4 incluye acelerador de IA dedicado para aplicaciones de machine learning','https://www.digitaltrends.com/tachyon/2024/11/macbook-pro-m4-pro-01.jpg?resize=1200%2C720',4,4,'published','2026-01-14 08:20:00','2026-06-21 03:31:43',2),
...
(23,'Starlink alcanza 5 millones de usuarios activos globalmente','starlink-5-millones-usuarios','Servicio de internet satelital expande cobertura a 75 países con velocidades mejoradas','https://cloudfront-us-east-1.images.arcpublishing.com/infobae/BD3QN4RGEVAXDGGAAICM3KXQVQ.png',1,5,'published','2026-01-12 11:15:00','2026-06-21 04:31:42',3),
(24,'Tesla Optimus realiza tareas de fábrica en línea de producción real','tesla-optimus-produccion-real','Robot humanoide de Tesla trabaja junto a humanos ensamblando componentes de vehículos','https://clickpetroleoegas.com.br/wp-content/uploads/2026/01/Design-sem-nome-2026-01-29T190106.112.jpg',3,5,'published','2026-01-11 16:50:00','2026-06-20 14:42:20',1),
(25,'Quantum computer de IBM supera los 1000 qubits útiles','ibm-quantum-1000-qubits','Procesador \"Condor\" marca hito en computación cuántica con corrección de errores integrada','https://i.blogs.es/1df1e8/qubit1/450_1000.jpg',4,5,'published','2026-01-10 09:35:00','2026-06-30 23:42:05',13),
(26,'Alphabet emite $15 000 M en bonos para financiar IA','alphabet-emite-bonos-ia-2026','Alphabet reabre mercado de bonos por 15 000 millones para invertir en IA en 2026 con fuerte interés global.','https://www.automatizapro.com.ar/wp-content/uploads/2025/11/alphabet-bonos-financiar-ia.jpg',1,1,'published','2026-02-14 12:21:38','2026-06-29 23:58:01',5),
(27,'Big Tech dispara inversiones en IA y brilla en CES 2026','big-tech-inversiones-ia-ces-2026','Las grandes tecnológicas presentaron innovaciones en IA y dispositivos inteligentes en CES 2026.','https://www.automatizapro.com.ar/wp-content/uploads/2026/02/big-tech-burbuja-financiera-ia-2026.jpg',1,5,'published','2026-01-07 10:30:00','2026-06-20 14:47:41',1),
(28,'Preocupación por aumento de precios de móviles y PCs por IA','aumento-precios-moviles-pcs-ia-2026','Expertos alertan que la demanda de IA encarece componentes clave como memoria y sube los precios.','https://cloudfront-us-east-1.images.arcpublishing.com/infobae/MPKMGMFDZBHTJEEJJ2XN4HLJT4.png',2,2,'published','2026-01-13 15:45:00','2026-06-20 14:53:46',1),
(29,'Robots, pantallas gigantes y nuevos procesadores dominan CES 2026','robots-pantallas-procesadores-ces-2026','La CES 2026 mostró robots autónomos y nuevos procesadores con inteligencia artificial integrada.','https://resizer.glanacion.com/resizer/v2/un-robot-sharpa-cumpliendo-su-rol-de-croupier-en-USYWRGBJBBFXJLKQG6QF37NXT4.JPG?auth=212fe4f448e06ab589fad8cbb19d74a14187a9138a039950027d126e5c59e09f&width=420&height=280&quality=70&smart=true',2,4,'published','2026-01-14 14:20:00','2026-06-20 14:57:40',1),
