...
(1,'Ana Torres','Periodista especializada en inteligencia artificial con más de 10 años de experiencia','ana-torres','',1),
(2,'Carlos Mendoza','Analista de hardware y dispositivos móviles, colaborador habitual en revistas especializadas','carlos-mendoza','',1),
(3,'Laura Vega','Desarrolladora de software y experta en nuevas tecnologías','laura-vega','',1),
(4,'Miguel Ruiz','Ingeniero en sistemas y especialista en hardware de PCs','miguel-ruiz','',1);
...
insert  into `news`(`id`,`title`,`slug`,`excerpt`,`cover_image`,`author_id`,`category_id`,`status`,`created_at`,`updated_at`,`active`,`views`) values 
...
(5,'Windows 13 incluye asistente de IA nativo','windows-13-asistente-ia-nativo','Microsoft integra Copilot directamente en el sistema operativo','https://i.blogs.es/876678/copilot-novedades/500_333.jpeg',3,3,'published','2026-01-30 10:10:00','2026-02-13 12:31:28',1,2),
(6,'Nueva versión de Python acelera ejecución en un 40%','python-nueva-version-acelera-ejecucion','Python 3.13 mejora significativamente el rendimiento de aplicaciones','https://pandorafms.com/blog/wp-content/uploads/2018/10/lenguaje-python-featured.png',3,3,'published','2026-01-29 13:55:00','2026-02-13 12:19:56',1,2),
(7,'Procesadores cuánticos disponibles para computadoras personales','procesadores-cuanticos-pc-personales','IBM lanza el primer procesador cuántico accesible para el mercado de consumo','https://i.blogs.es/491562/intelcuanticaap/1366_2000.jpg',4,4,'published','2026-01-28 15:40:00','2026-02-13 12:19:56',1,1),
...
(16,'Nothing Phone (3) con pantalla holográfica retroiluminada','nothing-phone-3-pantalla-holografica','Interfaz Glyph Interface evoluciona con efectos de luz 3D y notificaciones contextuales','https://i.blogs.es/2a45d5/nothing3/450_1000.jpeg',2,2,'published','2026-01-19 13:40:00','2026-02-05 21:03:48',1,0),
(17,'Visual Studio Code integra Copilot Chat de forma nativa','vscode-copilot-chat-nativo','Microsoft fusiona su IDE con herramientas de IA para desarrollo asistido','https://blog.underc0de.org/wp-content/uploads/2026/01/Sin-titulo-5.png',3,3,'published','2026-01-18 10:25:00','2026-02-05 21:04:26',1,0),
(18,'Kubernetes 1.30 simplifica la gestión de clusters con IA','kubernetes-1-30-gestion-ia','Nueva versión incluye operadores auto-curativos y optimización automática de recursos','https://www.muylinux.com/wp-content/uploads/2023/10/Kubernetes.png',3,3,'published','2026-01-17 15:10:00','2026-02-05 21:04:49',1,0),
(19,'Linux 6.10 mejora soporte para hardware ARM y RISC-V','linux-6-10-soporte-arm-riscv','Kernel actualizado optimiza rendimiento en procesadores de arquitectura alternativa','https://blog.underc0de.org/wp-content/uploads/2024/07/R.jpg',3,3,'published','2026-01-16 12:05:00','2026-02-05 21:06:05',1,0),
...
(25,'Quantum computer de IBM supera los 1000 qubits útiles','ibm-quantum-1000-qubits','Procesador \"Condor\" marca hito en computación cuántica con corrección de errores integrada','https://i.blogs.es/1df1e8/qubit1/450_1000.jpg',4,5,'published','2026-01-10 09:35:00','2026-02-05 21:09:32',1,0),
...
(38,'Linux anuncia kernel 100% escrito por IA con supervisión humana','linux-kernel-ia-escrito','Torvalds revela que 85% del código de Linux 7.0 fue generado y verificado por sistemas de IA','https://www.somoslibres.org/images/2022/03/03/ialinux.jpg',3,3,'published','2026-02-15 14:50:00','2026-02-15 13:39:53',1,0),
...
(42,'AMD APU con 256GB de memoria HBM4 integrada','amd-apu-256gb-hbm4','Chip \"Strix Halo\" elimina necesidad de RAM separada, revolucionando laptops gaming','https://acf.geeknetic.es/imgri/imagenes/auto/2025/11/21/rqe-amd-instinct-mi403x.png?f=webp',4,4,'published','2026-02-05 13:15:00','2026-02-15 13:44:05',1,0),
...
(44,'Hyperloop comercial conecta NYC-Washington en 25 minutos','hyperloop-nyc-washington-25min','Primera ruta de transporte supersónico subterráneo inaugurada en Estados Unidos','https://i.blogs.es/fc9c44/hyperloop/840_560.png',3,5,'published','2026-02-01 09:40:00','2026-02-15 13:44:50',1,0),
